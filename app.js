...
module.exports = function (conf) {
    ...
    */
    ...
    //For index. Basically app.get('/share/',...);
    app.use(express.static(publicPath));

    //For downloading files
    if (!disable.fileDownload) app.use('/share/f', express.static(filesFolderPath));
    ...
    app.get('/share/f/del/:filename', function (req, res) {
    ...
    app.post('/share/', function (req, res) {
        ...
        form.on('file', function (name, file) {
            res.redirect('/share/?success=' + encodeURIComponent(file.finalName));
        });

        form.on('error', function (err) {
            res.redirect('/share/?error=1');
        });
    ...
    app.get('/share/info', function (req, res) {
